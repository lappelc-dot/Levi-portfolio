...
if (container) {
  ...
  const earthTexture = loadTexture("resources/images/Earth Model/textures/earth albedo.jpg");
  const bumpTexture = loadTexture(
    "resources/images/Earth Model/textures/earth bump.jpg",
    THREE.NoColorSpace
  );
  const cloudTexture = loadTexture("resources/images/Earth Model/textures/clouds earth.png");
